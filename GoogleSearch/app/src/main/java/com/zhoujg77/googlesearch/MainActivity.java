package com.zhoujg77.googlesearch;
...
import com.zhoujg77.googlesearch.adapter.ArrayRecyclerAdapter;
import com.zhoujg77.googlesearch.dagger.DaggerAppComponent;
import com.zhoujg77.googlesearch.search.SearchController;
import com.zhoujg77.googlesearch.search.SearchResult;
import com.zhoujg77.googlesearch.utils.PackageUtils;
import com.zhoujg77.googlesearch.utils.ViewUtils;
import com.zhoujg77.library.internal.FloatingSearchView;

import javax.inject.Inject;

public class MainActivity extends AppCompatActivity implements ActionMenuView.OnMenuItemClickListener,SearchController.Listener{
    ...
    private void onItemClick(SearchResult result) {
        ...
        if(!TextUtils.isEmpty(result.url)){
            PackageUtils.start(this, Uri.parse(result.url));
        }
